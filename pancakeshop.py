...
class Stack():
    ...
    def remove_two(self):
        ...
        item1 = self._list.pop(0)
        item2 = self._list.pop(1)
...
def make_short_stack(words):
      """instantiate stack, add items, and return the stack instance"""
      stack = Stack(list(words))
...
if __name__ == '__main__':
    ...
    short = make_short_stack(fruits)
    short.push("durian")
    assert(short.length() == 4)
    assert(short.pop() == "durian")
    assert(short.length() == 3)
    print(short.remove_two())
